        ...
        <div class="well col-xs-10 col-sm-10 col-md-6 col-xs-offset-1 col-sm-offset-1 col-md-offset-3">
            <div class="row">
                <div class="col-xs-6 col-sm-6 col-md-6">
                    <address>
                        <strong>PO Haryanto Bnayumanik</strong>
                        <br>
                        Terminal Banyumanik
                ...
                <div class="col-xs-6 col-sm-6 col-md-6 text-right">
                    ...
                    <p>
                        <em><b>Booking</b> <br><?php echo $booked_timing; ?></em>
                    </p>
                </div>
            </div>
            <div class="row">
                <div class="text-center">
                    <h4><b>Kode Tiket:</b> <?php echo $pnr; ?></h5>
                    <h2>Detail Tiket</h2>
                </div>
                </span>
                <table class="table table-hover table-striped">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Nama Customer:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Kontak Customer:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Jam Keberangkatan:</b></em></h4></td>
                        ...
                        <tr>
                            ...
                            <td class="col-md-6"><em><b>Total Biaya:</b></em></h4></td>
                    
                            <td class="col-md-6 text-center"><?php echo $booked_amount; ?>K</td>
                ...
                <div>
                    ...
                    Terima kasih atas kepercayaan Anda pada PO Haryanto. Selamat perjalanan!
                    </h6>

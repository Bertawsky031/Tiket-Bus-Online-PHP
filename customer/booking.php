        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        ...
                        <p class="fw-light">Booking untuk pertama kalinya</p>
                        <hr>
            ...
            <section id="booking">
                <div id="head" class="mb-3">
                    <h4>Booking Terakhir</h4>
                </div>
                <div id="booking-results">
                    <div>
                        <button id="add-button" class="button btn-sm text-center" type="button"data-bs-toggle="modal" data-bs-target="#addModal">Tambah Booking<i class="fas fa-plus"></i></button>
                    </div>

        ...
        */
        if($loggedIn && $_SERVER["REQUEST_METHOD"] == "POST")
        {
            ...
            if(isset($_POST["edit"]))
            {
                ...
                if(!$id_if_bus_exists || $id == $id_if_bus_exists)
                {
                    ...
                    if(!$rowsAffected)
                    {
                        $messageInfo = "Dikelola oleh administrator!";
                    }
                    ...
                    elseif($updateResult)
                    {
                        ...
                        $messageHeading = "Sukses";
                        $messageInfo = "Bus Telah di Edit";
                    }
                    else{
                        // Show error alert
                        $messageInfo = "Permintaan Anda tidak dapat diproses karena masalah teknis dari pihak kami. Kami menyesal atas ketidaknyamanan yang disebabkan.";
                    }
            ...
            if(isset($_POST["delete"]))
            {
                ...
                {   
                    ...
                    // Show success alert
                    $messageStatus = "Sukses";
                    $messageInfo = "Detail Bus Berhasil di hapus";
                    $messageHeading = "Sukses";
        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">Bus Tidak ditemukan</h1>
                        <p class="fw-light">Tambahkan Data Bus Pertama</p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                Klik <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Tambah <i class="fas fa-plus"></i></button> untuk tambah Bus!
                        </div>
                    </div>
                </div>
            <?php }
            ...
            <section id="bus">
                ...
                <div id="bus-results">
                    <div>
                        <button id="add-button" class="button btn-sm" type="button"data-bs-toggle="modal" data-bs-target="#addModal">Tambah armada bus <i class="fas fa-plus"></i></button>
                    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                Apa kamu yakin mau menghapus Bus ini? <strong>Proses ini belum selesai.</strong>
                </p>
                <!-- Needed to pass id -->

        ...
        */
                ...
                <div class="modal-dialog">
                    ...
                    <div class="modal-body">
                        <form id="addRouteForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            <div class="mb-3">
                                    <label for="viaCities" class="form-label">Kota</label>
                                <input type="text" class="form-control" id="viaCities" name="viaCities" placeholder="Kota,Kota" required>
                                <span id="error">
                            ...
                            <div class="mb-3">
                                <label for="stepCost" class="form-label">Biaya</label>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                    Apa kamu yakin mau menghapus rute ini? <strong>Proses ini belum selesai.</strong>
                </p>
                <!-- Needed to pass id -->

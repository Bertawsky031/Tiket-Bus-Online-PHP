            ...
            if(isset($_POST["edit"]))
            {
                ...
                if(!$id_if_customer_exists || $customer_id == $id_if_customer_exists)
                {
                    ...
                    elseif($updateResult)
                    {
                        ...
                        $messageInfo = "Customer Telah di Edit";
                    }
                    else{
                        
                        $messageInfo = "Tidak bisa dilanjutkan lagii";
                    }
        ...
        <?php
            ...
            if(!mysqli_num_rows($resultSqlResult)){ ?>
                ...
                <div class="container mt-4">
                    <div id="noCustomers" class="alert alert-dark " role="alert">
                        <h1 class="alert-heading">Tidak ada booking</h1>
                        <p class="fw-light">Tmabahkan untuk yang pertama</p>
                        <hr>
                        <div id="addCustomerAlert" class="alert alert-success" role="alert">
                                Klik <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Tambah <i class="fas fa-plus"></i></button> Tambah Booking!
                        </div>
                    </div>
                </div>
            <?php }
            ...
            <section id="booking">
                ...
                <div id="booking-results">
                    <div>
                        <button id="add-button" class="button btn-sm"type="button"data-bs-toggle="modal" data-bs-target="#addModal">Tambah Booking<i class="fas fa-plus"></i></button>
                    </div>
    ...
    <div class="modal fade" id="addModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div class="modal-dialog modal-lg modal-dialog-scrollable">
                    ...
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Buat Booking</h5>
                    ...
                    <div class="modal-body">
                        <form id="addBookingForm" action="<?php echo $_SERVER['REQUEST_URI']; ?>" method="POST">
                            ...
                            <div class="mb-3">
                                <label for="cid" class="form-label">ID Pelanggan</label>
                                <!-- Search -->
                            ...
                            <div class="mb-3">
                                <label for="cphone" class="form-label">Nomor</label>
                            ...
                            <div class="mb-3">
                                <label for="sourceSearch" class="form-label">Sumber</label>
                            ...
                            <div class="mb-3">
                                <label for="bookAmount" class="form-label">Total Biaya</label>
...
>
        ...
        <div class="modal-dialog modal-dialog-centered">
            ...
            <div class="modal-body">
                ...
                <p>
                Apa kamu yakin mau menghapus Pelanggan ini? <strong>Proses ini belum selesai.</strong>
                </p>
                <!-- Needed to pass id -->
            ...
            <div class="modal-footer d-flex justify-content-center">
                ...
                <button type="submit" form="delete-form" name="delete" class="btn btn-danger">Hapus</button>
            </div>
            </div>
        </div>
    </div>
